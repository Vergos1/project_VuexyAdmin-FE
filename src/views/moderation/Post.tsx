      ...
      <Card>
        ...
        <CardContent>
          <div className='border rounded-md'>
            <div className='px-2 pt-2 flex gap-4'>
              <CardMedia
                className='w-1/4'
                component='img'
                height={255}
                image='/images/illustrations/moderation/block.png'
                alt='block'
              />
              <CardMedia
                className='w-1/4'
                component='img'
                height={255}
                image='/images/illustrations/moderation/block-2.png'
                alt='block'
              />
              <CardMedia
                className='w-1/4'
                component='img'
                height={255}
                image='/images/illustrations/moderation/block-3.png'
                alt='block'
              />
              <CardMedia
                className='w-1/4'
                component='img'
                height={255}
                image='/images/illustrations/moderation/block-4.png'
                alt='block'
              />
            </div>
            <CardContent>
